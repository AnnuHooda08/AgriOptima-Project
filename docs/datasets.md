...
| --- | --- | --- |
| Historical India mandi prices | `Mandi_Prices/` | Reassemble the 11 parts into the original ZIP using its README; 56.9 million reported rows in 325 commodity CSVs. |
